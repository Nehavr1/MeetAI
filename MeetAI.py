...
generator = pipeline(
    ...
    model="gpt2",
    device=-1,
    truncation=True  # Explicitly enabling truncation
)
...
class EventAgent:
    ...
    def prepare_context(self, top_results, max_context_length=100):
        ...
        for score, idx in zip(top_results.values, top_results.indices):
            ...
            retrieved_contexts.append(truncate_text(retrieved_context, max_context_length))
...
def main():
    print("🔍 Welcome to the RAG-Enhanced Event Finder with Query Levels!")
